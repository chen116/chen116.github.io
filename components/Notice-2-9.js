app.component('notice-2-9', {
  ...
  <ul class="list-group list-group-flush" >
    ...
    <li class="list-group-item list-group-flush"><b>人才培育範疇包含：</b>
      <li class="list-group-item list-group-flush" v-for="item in list2">
      <img class="rounded" src="./assets/images/menu01.jpg"/><span>&nbsp;&nbsp;</span>{{item}}
      </li>
    </li>
  </ul>
  ...
  <ul class="list-group list-group-flush" v-for="item in list3">

    <li class="list-group-item list-group-flush"><b>{{item.title}}</b>
      <li class="list-group-item list-group-flush" v-for="detail in item.details">
  ...
  <ul class="list-group list-group-flush" v-for="item in list4">
